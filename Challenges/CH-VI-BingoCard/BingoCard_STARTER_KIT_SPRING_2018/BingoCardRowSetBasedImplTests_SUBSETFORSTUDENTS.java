...
public class BingoCardRowSetBasedImplTests_SUBSETFORSTUDENTS
{
	...
	private static BingoCard getBingoCard(Integer[][] entries)
	{
		...
		//return new BingoCardRowSetBasedImpl_Skeleton//Student can call any constructor that they want here:
		
		throw new RuntimeException("Student can call any constructor of their BingoCardRowSetBasedImpl_LastName class that they want");
	}
}
